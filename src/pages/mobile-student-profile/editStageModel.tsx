...
// ** MUI Imports
import { Button, Checkbox, CircularProgress, Divider, FormControlLabel, Switch, TextareaAutosize } from '@mui/material'
                        ...
                        <Box sx={{ p: 5 }}>
                            ...
                            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                ...
                                <Typography variant='h6' sx={{ fontWeight: 400, display: 'flex', alignItems: 'center', gap: '10px' }}>
                                    ...
                                    <FormControlLabel 
                                        control={
                                            <Switch checked={isFulilledStatus} onChange={(e) => { setIsFulFilledStatus(prev => !prev) }} />
                                        }
                                        label="Progress"
                                    />
