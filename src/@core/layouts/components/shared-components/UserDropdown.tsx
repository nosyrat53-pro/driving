    ...
    <Fragment>
      ...
      >
        <Box sx={{ py: 1.75, px: 6 }}>
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Box sx={{ display: 'flex', ml: 2.5, alignItems: 'flex-start', flexDirection: 'column' }}>
              <Typography sx={{ fontWeight: 500 }}>{JSON.parse(localStorage.getItem('userData')).fullName}</Typography>
        ...
        <MenuItemStyled sx={{ p: 0 }} onClick={() => handleDropdownClose()}>
          <Box sx={styles}>
            <Typography component={LinkStyled} href={`/student-profile/${JSON.parse(localStorage.getItem('userData')).id}`}>
